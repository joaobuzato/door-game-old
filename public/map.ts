...
export const map :Room[]= [
    ...
    },
    {
        ...
        actions: [
            {id: 3, type:"use", buttonText: "Fincar a faca no chão", element:"faca", param: 1, text:"Você USOU a faca puta merdaaaaaaaaaaaaaaaaaaaa!", conditions:[{element1:"faca", type:"greater", element2:0}]},
